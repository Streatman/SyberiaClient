class HomebookMenu extends UIScriptedMenu
{
	...
	{
		layoutRoot = GetGame().GetWorkspace().CreateWidgets( "IntenZ/SyberiaClient/Configs/layout/HomebookMenu.layout" );
	...
	{		
		ref Widget itemWidget = GetGame().GetWorkspace().CreateWidgets( "IntenZ/SyberiaClient/Configs/layout/HomebookMenuItemDoor.layout" );		
		...
		if (m_livespace.IsDoorOpen(doorData.m_selfDoorId)) {
			widgetIcon.LoadImageFile(0, "IntenZ/SyberiaClient/configs/data/Homebook/icon_unlocked.paa");
			doorState = "State: Opened";		
		}
		else {
			widgetIcon.LoadImageFile(0, "IntenZ/SyberiaClient/configs/data/Homebook/icon_locked.paa");
	...
	{
		ref Widget itemWidget = GetGame().GetWorkspace().CreateWidgets( "IntenZ/SyberiaClient/configs/layout/HomebookMenuConsumable.layout" );		
