...
class PerksCollection
{
	...
	{
	//--IMMUNITY
		Register(SyberiaPerkType.SYBPERK_IMMUNITY_INFLUENZA_TIME, "#syb_perk_desc_p2_0").AddUnlockValue(1, 5).AddUnlockValue(10, 15).AddUnlockValue(20, 30).AddUnlockValue(32, 50).AddUnlockValue(47, 80).AddUnlockValue(85, 120);
		Register(SyberiaPerkType.SYBPERK_IMMUNITY_STOMATCHPOISON_TIME, "#syb_perk_desc_p2_1").AddUnlockValue(1, 5).AddUnlockValue(10, 15).AddUnlockValue(20, 30).AddUnlockValue(32, 50).AddUnlockValue(47, 80).AddUnlockValue(85, 120);
		
	//	Register(SyberiaPerkType.SYBPERK_IMMUNITY_ZVIRUS_TIME, "#syb_perk_desc_p2_2").AddUnlockValue(40, 15).AddUnlockValue(65, 30).AddUnlockValue(100, 120);
		Register(SyberiaPerkType.SYBPERK_IMMUNITY_SEPSIS_TIME, "#syb_perk_desc_p2_3").AddUnlockValue(40, 15).AddUnlockValue(65, 30).AddUnlockValue(100, 120);
		
		Register(SyberiaPerkType.SYBPERK_IMMUNITY_PAIN_STRONG, "#syb_perk_desc_p2_4").AddUnlockValue(100, 1);
		Register(SyberiaPerkType.SYBPERK_IMMUNITY_OVERDOSE_STRONG, "#syb_perk_desc_p2_5").AddUnlockValue(5, 10).AddUnlockValue(15, 20).AddUnlockValue(25, 35).AddUnlockValue(36, 50).AddUnlockValue(57, 75).AddUnlockValue(100, 200);
		
		Register(SyberiaPerkType.SYBPERK_IMMUNITY_HEMATOMA_CHANCE, "#syb_perk_desc_p2_6").AddUnlockValue(30, 10).AddUnlockValue(43, 20).AddUnlockValue(70, 30);
		Register(SyberiaPerkType.SYBPERK_IMMUNITY_CUTHIT_CHANCE, "#syb_perk_desc_p2_7").AddUnlockValue(30, 10).AddUnlockValue(43, 20).AddUnlockValue(70, 30);
		
		Register(SyberiaPerkType.SYBPERK_IMMUNITY_HEMATOMA_TIME, "#syb_perk_desc_p2_8").AddUnlockValue(3, 5).AddUnlockValue(12, 10).AddUnlockValue(23, 20).AddUnlockValue(34, 30).AddUnlockValue(53, 40).AddUnlockValue(90, 50);
		Register(SyberiaPerkType.SYBPERK_IMMUNITY_CUTHIT_TIME, "#syb_perk_desc_p2_9").AddUnlockValue(3, 5).AddUnlockValue(12, 10).AddUnlockValue(23, 20).AddUnlockValue(34, 30).AddUnlockValue(53, 40).AddUnlockValue(90, 50);
		
		Register(SyberiaPerkType.SYBPERK_IMMUNITY_UNCUNSION_CHANCE, "#syb_perk_desc_p2_10").AddUnlockValue(7, 2).AddUnlockValue(18, 5).AddUnlockValue(28, 10).AddUnlockValue(38, 15).AddUnlockValue(60, 20).AddUnlockValue(95, 25);
		Register(SyberiaPerkType.SYBPERK_IMMUNITY_UNCUNSION_TIME, "#syb_perk_desc_p2_11").AddUnlockValue(7, 2).AddUnlockValue(18, 5).AddUnlockValue(28, 10).AddUnlockValue(38, 15).AddUnlockValue(60, 20).AddUnlockValue(95, 25);
		
		Register(SyberiaPerkType.SYBPERK_IMMUNITY_SLEEPING_TIME, "#syb_perk_desc_p2_12").AddUnlockValue(5, 10).AddUnlockValue(15, 20).AddUnlockValue(25, 30).AddUnlockValue(36, 50).AddUnlockValue(57, 80).AddUnlockValue(100, 120);
		Register(SyberiaPerkType.SYBPERK_IMMUNITY_MENTAL_TIME, "#syb_perk_desc_p2_13").AddUnlockValue(5, 10).AddUnlockValue(15, 20).AddUnlockValue(25, 30).AddUnlockValue(36, 40).AddUnlockValue(57, 50).AddUnlockValue(100, 80);
		
		Register(SyberiaPerkType.SYBPERK_IMMUNITY_INFLUENZA_FIREPLACE_HEAL).AddUnlockValue(50, 1);
		
	//--ATHLETICS
		Register(SyberiaPerkType.SYBPERK_ATHLETICS_SPRINT_DEC, "#syb_perk_desc_p2_1000").AddUnlockValue(1, 10).AddUnlockValue(12, 20).AddUnlockValue(30, 30).AddUnlockValue(50, 40).AddUnlockValue(70, 50).AddUnlockValue(90, 70).AddUnlockValue(100, 90);
		Register(SyberiaPerkType.SYBPERK_ATHLETICS_JOG_INC, "#syb_perk_desc_p2_1001").AddUnlockValue(1, 10).AddUnlockValue(12, 20).AddUnlockValue(30, 30).AddUnlockValue(50, 40).AddUnlockValue(70, 50).AddUnlockValue(90, 70).AddUnlockValue(100, 100);
		
		Register(SyberiaPerkType.SYBPERK_ATHLETICS_SWIM_SPRINT_DEC, "#syb_perk_desc_p2_1002").AddUnlockValue(3, 20).AddUnlockValue(15, 35).AddUnlockValue(35, 50).AddUnlockValue(55, 70).AddUnlockValue(75, 90);
		Register(SyberiaPerkType.SYBPERK_ATHLETICS_SWIM_INC, "#syb_perk_desc_p2_1003").AddUnlockValue(3, 20).AddUnlockValue(15, 35).AddUnlockValue(35, 50).AddUnlockValue(55, 70).AddUnlockValue(75, 90);
		
		Register(SyberiaPerkType.SYBPERK_ATHLETICS_LADDER_SPRINT_DEC, "#syb_perk_desc_p2_1004").AddUnlockValue(6, 20).AddUnlockValue(18, 35).AddUnlockValue(40, 50).AddUnlockValue(60, 70).AddUnlockValue(80, 90);
		Register(SyberiaPerkType.SYBPERK_ATHLETICS_LADDER_INC, "#syb_perk_desc_p2_1005").AddUnlockValue(6, 20).AddUnlockValue(18, 35).AddUnlockValue(40, 50).AddUnlockValue(60, 70).AddUnlockValue(80, 90);
		
		Register(SyberiaPerkType.SYBPERK_ATHLETICS_BREATH_DEC, "#syb_perk_desc_p2_1006").AddUnlockValue(9, 10).AddUnlockValue(22, 20).AddUnlockValue(45, 30).AddUnlockValue(65, 40).AddUnlockValue(85, 50).AddUnlockValue(95, 80).AddUnlockValue(100, 120);
		Register(SyberiaPerkType.SYBPERK_ATHLETICS_IDDLE_INC, "#syb_perk_desc_p2_1007").AddUnlockValue(9, 10).AddUnlockValue(22, 20).AddUnlockValue(45, 30).AddUnlockValue(65, 40).AddUnlockValue(85, 50).AddUnlockValue(95, 80).AddUnlockValue(100, 120);
		Register(SyberiaPerkType.SYBPERK_ATHLETICS_COLDOWN_DEC, "#syb_perk_desc_p2_1010").AddUnlockValue(9, 10).AddUnlockValue(22, 20).AddUnlockValue(45, 30).AddUnlockValue(65, 40).AddUnlockValue(85, 50).AddUnlockValue(95, 60).AddUnlockValue(100, 90);
		
	//--STRENGTH
		Register(SyberiaPerkType.SYBPERK_STRENGTH_STAMINA_KG_TO, "#syb_perk_desc_p2_2000").AddUnlockValue(1, 10).AddUnlockValue(18, 20).AddUnlockValue(36, 30).AddUnlockValue(50, 40).AddUnlockValue(65, 50).AddUnlockValue(76, 60).AddUnlockValue(88, 70).AddUnlockValue(100, 90);
		Register(SyberiaPerkType.SYBPERK_STRENGTH_STAMINA_MAX, "#syb_perk_desc_p2_2001").AddUnlockValue(1, 10).AddUnlockValue(18, 20).AddUnlockValue(36, 30).AddUnlockValue(50, 40).AddUnlockValue(65, 50).AddUnlockValue(76, 60).AddUnlockValue(88, 70).AddUnlockValue(100, 90);
		
		Register(SyberiaPerkType.SYBPERK_STRENGTH_JUMP_STAMINA_DEC, "#syb_perk_desc_p2_2002").AddUnlockValue(3, 20).AddUnlockValue(24, 30).AddUnlockValue(40, 40).AddUnlockValue(54, 50).AddUnlockValue(68, 60).AddUnlockValue(79, 70).AddUnlockValue(90, 80);
	//	Register(SyberiaPerkType.SYBPERK_STRENGTH_BLOCK_STAMINA_DEC, "#syb_perk_desc_p2_2003").AddUnlockValue(3, 20).AddUnlockValue(24, 30).AddUnlockValue(40, 40).AddUnlockValue(54, 50).AddUnlockValue(68, 60).AddUnlockValue(79, 70).AddUnlockValue(90, 80);
		
		Register(SyberiaPerkType.SYBPERK_STRENGTH_FAST_ATTACK_STAMINA_DEC, "#syb_perk_desc_p2_2004").AddUnlockValue(5, 20).AddUnlockValue(28, 30).AddUnlockValue(43, 40).AddUnlockValue(58, 50).AddUnlockValue(70, 60).AddUnlockValue(82, 70).AddUnlockValue(93, 80);
		Register(SyberiaPerkType.SYBPERK_STRENGTH_FAST_ATTACK_STRENGTH, "#syb_perk_desc_p2_2005").AddUnlockValue(5, 20).AddUnlockValue(28, 30).AddUnlockValue(43, 40).AddUnlockValue(58, 50).AddUnlockValue(70, 60).AddUnlockValue(82, 70).AddUnlockValue(93, 80);
		
		Register(SyberiaPerkType.SYBPERK_STRENGTH_HEAVY_ATTACK_STAMINA_DEC, "#syb_perk_desc_p2_2006").AddUnlockValue(12, 20).AddUnlockValue(32, 30).AddUnlockValue(47, 40).AddUnlockValue(62, 50).AddUnlockValue(73, 60).AddUnlockValue(85, 70).AddUnlockValue(97, 80);
		Register(SyberiaPerkType.SYBPERK_STRENGTH_HEAVY_ATTACK_STRENGTH, "#syb_perk_desc_p2_2007").AddUnlockValue(12, 20).AddUnlockValue(32, 30).AddUnlockValue(47, 40).AddUnlockValue(62, 50).AddUnlockValue(73, 60).AddUnlockValue(85, 70).AddUnlockValue(97, 80);
	...
	//--MEDICINE
		Register(SyberiaPerkType.SYBPERK_MEDICINE_TABLETS_RESEARCH).AddUnlockValue(20, 1);
		Register(SyberiaPerkType.SYBPERK_MEDICINE_AMPOULES_RESEARCH).AddUnlockValue(40, 1);
		
		Register(SyberiaPerkType.SYBPERK_MEDICINE_INJECTORS_RESEARCH).AddUnlockValue(30, 1);	 
		Register(SyberiaPerkType.SYBPERK_MEDICINE_SURGEON_KNIFE_HITS, "#syb_perk_desc_p2_3003").AddUnlockValue(2, 30).AddUnlockValue(14, 50).AddUnlockValue(28, 75).AddUnlockValue(71, 100);
		
		Register(SyberiaPerkType.SYBPERK_MEDICINE_SURGEON_BULLET_HITS, "#syb_perk_desc_p2_3004").AddUnlockValue(4, 20).AddUnlockValue(16, 40).AddUnlockValue(35, 60).AddUnlockValue(78, 80).AddUnlockValue(100, 100);
		Register(SyberiaPerkType.SYBPERK_MEDICINE_SURGEON_VISCERA_HITS, "#syb_perk_desc_p2_3005").AddUnlockValue(6, 10).AddUnlockValue(18, 20).AddUnlockValue(45, 40).AddUnlockValue(85, 60).AddUnlockValue(100, 80);
		
		Register(SyberiaPerkType.SYBPERK_MEDICINE_TOOLS_DEGRADATION_DEC, "#syb_perk_desc_p2_3006").AddUnlockValue(12, 10).AddUnlockValue(24, 25).AddUnlockValue(64, 50);
		Register(SyberiaPerkType.SYBPERK_MEDICINE_SEPSIS_CHANCE_DEC, "#syb_perk_desc_p2_3007").AddUnlockValue(8, 5).AddUnlockValue(22, 10).AddUnlockValue(57, 25).AddUnlockValue(92, 50).AddUnlockValue(100, 75);
		
		Register(SyberiaPerkType.SYBPERK_MEDICINE_BRING_FROM_UNCUNSION).AddUnlockValue(10, 1);
		Register(SyberiaPerkType.SYBPERK_MEDICINE_SHOW_PLAYER_STATE).AddUnlockValue(26, 1);
		
	//	Register(SyberiaPerkType.SYBPERK_MEDICINE_START_LOADOUT).AddUnlockValue(100, 1);
		Register(SyberiaPerkType.SYBPERK_MEDICINE_DEATH_CAUSE).AddUnlockValue(50, 1);
		
	//--STEALTH
		Register(SyberiaPerkType.SYBPERK_STEALTH_VOICE_SOUND_DEC, "#syb_perk_desc_p2_4000").AddUnlockValue(2, 10).AddUnlockValue(10, 20).AddUnlockValue(22, 30).AddUnlockValue(34, 40).AddUnlockValue(46, 50).AddUnlockValue(60, 60).AddUnlockValue(74, 70).AddUnlockValue(90, 80).AddUnlockValue(100, 100);
		Register(SyberiaPerkType.SYBPERK_STEALTH_WEAPONS_SOUND_DEC, "#syb_perk_desc_p2_4001").AddUnlockValue(3, 10).AddUnlockValue(12, 20).AddUnlockValue(24, 30).AddUnlockValue(36, 40).AddUnlockValue(48, 50).AddUnlockValue(62, 60).AddUnlockValue(78, 70).AddUnlockValue(92, 80).AddUnlockValue(100, 95);
		
		Register(SyberiaPerkType.SYBPERK_STEALTH_EQUIPMENT_SOUND_DEC, "#syb_perk_desc_p2_4002").AddUnlockValue(4, 10).AddUnlockValue(14, 20).AddUnlockValue(26, 30).AddUnlockValue(38, 40).AddUnlockValue(52, 50).AddUnlockValue(64, 60).AddUnlockValue(82, 70).AddUnlockValue(94, 80).AddUnlockValue(100, 95);
		Register(SyberiaPerkType.SYBPERK_STEALTH_ZOMBIE_AGRO_DEC, "#syb_perk_desc_p2_4003").AddUnlockValue(5, 5 ).AddUnlockValue(16, 10).AddUnlockValue(28, 20).AddUnlockValue(40, 30).AddUnlockValue(54, 40).AddUnlockValue(66, 50).AddUnlockValue(84, 60).AddUnlockValue(96, 70).AddUnlockValue(100, 90);
		
		Register(SyberiaPerkType.SYBPERK_STEALTH_CAT_VISSION, "#syb_perk_desc_p2_4004").AddUnlockValue(6, 10).AddUnlockValue(18, 20).AddUnlockValue(30, 30).AddUnlockValue(42, 40).AddUnlockValue(56, 50).AddUnlockValue(68, 60).AddUnlockValue(86, 70).AddUnlockValue(98, 80).AddUnlockValue(100, 120);
		Register(SyberiaPerkType.SYBPERK_STEALTH_STEPS_SOUND_DEC, "#syb_perk_desc_p2_4005").AddUnlockValue(1, 10).AddUnlockValue(8 , 20).AddUnlockValue(20, 30).AddUnlockValue(32, 40).AddUnlockValue(44, 50).AddUnlockValue(58, 60).AddUnlockValue(72, 70).AddUnlockValue(88, 80).AddUnlockValue(100, 95);
	...
	//	Register(SyberiaPerkType.SYBPERK_SURVIVAL_MUSHROOMS_RESEARCH).AddUnlockValue(25, 1);
		...
		Register(SyberiaPerkType.SYBPERK_SURVIVAL_CUTHIT_HANDS_DEC, "#syb_perk_desc_p2_5004").AddUnlockValue(3, 5).AddUnlockValue(12, 10).AddUnlockValue(20, 15).AddUnlockValue(32, 20).AddUnlockValue(42, 25).AddUnlockValue(52, 30).AddUnlockValue(62, 40).AddUnlockValue(70, 50).AddUnlockValue(82, 60).AddUnlockValue(90, 70).AddUnlockValue(98, 80).AddUnlockValue(100, 100);
		Register(SyberiaPerkType.SYBPERK_SURVIVAL_CUTHIT_LEGS_DEC, "#syb_perk_desc_p2_5005").AddUnlockValue(3, 5).AddUnlockValue(12, 10).AddUnlockValue(20, 15).AddUnlockValue(32, 20).AddUnlockValue(42, 25).AddUnlockValue(52, 30).AddUnlockValue(62, 40).AddUnlockValue(70, 50).AddUnlockValue(82, 60).AddUnlockValue(90, 70).AddUnlockValue(98, 80).AddUnlockValue(100, 100);
		
		Register(SyberiaPerkType.SYBPERK_SURVIVAL_TOOLS_DEGRADATION_DEC, "#syb_perk_desc_p2_5006").AddUnlockValue(40, 2).AddUnlockValue(60, 3).AddUnlockValue(80, 4).AddUnlockValue(100, 5);
		Register(SyberiaPerkType.SYBPERK_SURVIVAL_DIG_ITEMS).AddUnlockValue(9, 1);
		
		Register(SyberiaPerkType.SYBPERK_SURVIVAL_KEEPING_FIRE, "#syb_perk_desc_p2_5008").AddUnlockValue(40, 10).AddUnlockValue(60, 25).AddUnlockValue(80, 50).AddUnlockValue(100, 75);
		Register(SyberiaPerkType.SYBPERK_SURVIVAL_FROST_RESIST, "#syb_perk_desc_p2_5009").AddUnlockValue(2, 2).AddUnlockValue(8, 5).AddUnlockValue(18, 8).AddUnlockValue(28, 10).AddUnlockValue(38, 12).AddUnlockValue(48, 15).AddUnlockValue(58, 18).AddUnlockValue(68, 20).AddUnlockValue(78, 25).AddUnlockValue(88, 30).AddUnlockValue(95, 35).AddUnlockValue(100, 50);
	...
	//-- FARMING
		...
		*/
	//--HUNTING
		Register(SyberiaPerkType.SYBPERK_HUNTING_MEAT_COUNT, "#syb_perk_desc_p2_7000").AddUnlockValue(1, 10).AddUnlockValue(3, 15).AddUnlockValue(5, 20).AddUnlockValue(10, 30).AddUnlockValue(30, 40).AddUnlockValue(45, 60).AddUnlockValue(70, 80).AddUnlockValue(90, 100).AddUnlockValue(100, 150);
		Register(SyberiaPerkType.SYBPERK_HUNTING_SKINING, "#syb_perk_desc_p2_7001").AddUnlockValue(15, 20).AddUnlockValue(35, 30).AddUnlockValue(55, 50).AddUnlockValue(95, 70).AddUnlockValue(100, 100);
		
	//	Register(SyberiaPerkType.SYBPERK_HUNTING_DECOY_USE).AddUnlockValue(25, 1);		
		Register(SyberiaPerkType.SYBPERK_HUNTING_BUTCH_SPEED, "#syb_perk_desc_p2_7003").AddUnlockValue(2, 5).AddUnlockValue(8, 10).AddUnlockValue(22, 20).AddUnlockValue(38, 30).AddUnlockValue(50, 40).AddUnlockValue(62, 50).AddUnlockValue(78, 60).AddUnlockValue(92, 70).AddUnlockValue(100, 95);
		
		Register(SyberiaPerkType.SYBPERK_HUNTING_USE_TRAPS, "#syb_perk_desc_p2_7004").AddUnlockValue(6, 5).AddUnlockValue(13, 10).AddUnlockValue(18, 15).AddUnlockValue(32, 20).AddUnlockValue(42, 25).AddUnlockValue(52, 30).AddUnlockValue(68, 40).AddUnlockValue(80, 50).AddUnlockValue(98, 60).AddUnlockValue(100, 80);
		Register(SyberiaPerkType.SYBPERK_HUNTING_TOOLS, "#syb_perk_desc_p2_7005").AddUnlockValue(4, 5).AddUnlockValue(12, 10).AddUnlockValue(20, 20).AddUnlockValue(40, 40).AddUnlockValue(60, 60).AddUnlockValue(85, 80).AddUnlockValue(100, 100);
		/*
	//--FISHING
	...
	//--BUILDING
		Register(SyberiaPerkType.SYBPERK_BUILDING_LOCK_DOORS, " #syb_skill_level2").AddUnlockValue(1, 1).AddUnlockValue(5, 2).AddUnlockValue(10, 3).AddUnlockValue(25, 4).AddUnlockValue(50, 5).AddUnlockValue(100, 6);
	...
	//--LOCKPICKING
		...
		Register(SyberiaPerkType.SYBPERK_LOCKPICKING_BREAK_LOCKS, " #syb_skill_level2").AddUnlockValue(30, 1).AddUnlockValue(40, 2).AddUnlockValue(60, 3).AddUnlockValue(80, 4).AddUnlockValue(100, 5);
...
class PerkInfo
{
	...
	{
		string result = "#syb_perk_desc_p1_" + GetId();
		if (m_unitsType != "")
		{
