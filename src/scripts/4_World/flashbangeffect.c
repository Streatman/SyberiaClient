modded class FlashbangEffect
{
	...
	override void SetupFlashbangValues(float progress_mult = 1.0, float visual_value_max = 1.0, float sound_value_max = 1.0)
	{
		if ( !m_Initialized )
		{
			m_Initialized = true;
	...
	override protected void SetAttenuationFilter()
	{
	...
	override protected void ResetAttenuationFilter()
	{
	...
	override protected void ClearVisual()
	{
		if (m_Requester)
		{
			m_Requester.Stop();
	...
	override protected void SetVisual(float val)
	{
