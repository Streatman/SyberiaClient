class Stethoscope: Clothing
{
	...
	model="intenz\syberiaclient\medical\Stethoscope_g.p3d";
	...
	class ClothingTypes
	{
		male="intenz\syberiaclient\medical\Stethoscope_m.p3d";
		female="intenz\syberiaclient\medical\Stethoscope_m.p3d";
	};
	class AnimEvents
	{
		class SoundWeapon
